...
Atajos web (Filmin, Polar Cloud, Grok, ChatGPT,
Claude, Gemini, Perplexity, Copilot, Les vencimos)
entre los iconos pequeños; abren en el navegador.
...
def main() -> None:
    ...
    snapshot = ROOT / "downloads" / "estanteria-offline-v20260924t.zip"
